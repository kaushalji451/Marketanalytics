          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 text-black dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              <div className="flex justify-between mb-4 border-slate-400 border items-center rounded-lg ">
                <button className="text-black border-e border-slate-400 font-medium text-sm px-5 py-2.5 w-full text-center me-2" onClick={() => setuserOrAdmin("user")}>
                  user
                </button>
                <button className="text-black  font-medium text-sm px-5 py-2.5 w-full text-center" onClick={() => setuserOrAdmin("admin")}>
                  {" "}
                  admin
                </button>
              </div>
